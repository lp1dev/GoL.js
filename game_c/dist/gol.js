...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'gol.wast';
  var wasmBinaryFile = 'gol.wasm';
  var asmjsCodeFile = 'gol.temp.asm.js';
...
var real__create = asm["_create"]; asm["_create"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__create.apply(null, arguments);
};
...
var real__next = asm["_next"]; asm["_next"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__next.apply(null, arguments);
};
...
var _create = Module["_create"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_create"].apply(null, arguments) };
...
var _next = Module["_next"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_next"].apply(null, arguments) };
